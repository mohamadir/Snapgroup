...
public class MultiContactPickerActivity extends LocalizationActivity implements MaterialSearchView.OnQueryTextListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        SharedPreferences settingss=getSharedPreferences("Locality",MODE_PRIVATE);
        String lang=settingss.getString("lang-key","");
        if (!lang.equals("")){
            setLanguage(lang);
...
// Use conf.locale = new Locale(...) if targeting lower versions
            ...
            String languageToLoad  = lang; //pass the language code as param
            Locale locale;
        ...
        adapter = new MultiContactPickerAdapter(contactList, new MultiContactPickerAdapter.ContactSelectListener() {
            ...
            public void onContactSelected(Contact contact, int totalSelectedContacts) {
                ...
                if (tvSelectBtn.isEnabled())
                {
                    tvSelectBtn.setTextColor(Color.parseColor("#9a9a9a"));
                    tvSelectBtn.setTypeface(null, Typeface.BOLD);


                }
                else
                {
                    tvSelectBtn.setTextColor(Color.parseColor("#cfcfcf"));
                    tvSelectBtn.setTypeface(null, Typeface.NORMAL);
        ...
        RxContacts.fetch(this)
                ...
                .subscribe(new Observer<Contact>() {
                    ...
                    public void onComplete() {
                        ...
                        tvSelectAll.setTextColor(Color.parseColor("#9a9a9a"));
                        tvSelectAll.setTypeface(null, Typeface.BOLD);
